...
require 'google/resourcemanager/network/delete'
...
Puppet::Type.type(:gresourcemanager_project).provide(:google) do
  mk_resource_methods
  ...
  def create
    debug('create')
    @created = true
    create_req = Google::Resourcemanager::Network::Post.new(collection(@resource),
                                                            fetch_auth(@resource),
                                                            'application/json',
                                                            resource_to_request)
  ...
  def destroy
    debug('destroy')
    @deleted = true
    delete_req = Google::Resourcemanager::Network::Delete.new(self_link(@resource),
                                                              fetch_auth(@resource))
  ...
  def flush
    ...
    update_req = Google::Resourcemanager::Network::Put.new(self_link(@resource),
                                                           fetch_auth(@resource),
                                                           'application/json',
                                                           resource_to_request)
  ...
  def self.fetch_resource(resource, self_link)
    get_request = ::Google::Resourcemanager::Network::Get.new(
